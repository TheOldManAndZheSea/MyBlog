...
namespace ZR.Service.System
{
    ...
    public class SysFileService : BaseService<SysFile>, ISysFileService
    {
        ...
        /// <returns></returns>
        public (HttpStatusCode, string, string) SaveFile(string picdir, IFormFile formFile)
        {
        ...
        /// <returns></returns>
        public (HttpStatusCode, string, string) SaveFile(string picdir, IFormFile formFile, string customFileName, string bucketName)
        {
            ...
            return (statusCode, webUrl, fileName);
        }

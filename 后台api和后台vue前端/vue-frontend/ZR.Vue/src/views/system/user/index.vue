...
export default {
  ...
  data() {
    return {
      ...
      // 列信息
      columns: [
        // { key: 0, label: `用户编号`, checked: true },
        // { key: 1, label: `用户名称`, checked: true },
        // { key: 2, label: `用户昵称`, checked: true },
        // { key: 3, label: `部门`, checked: true },
        // { key: 4, label: `手机号码`, checked: true },
        // { key: 5, label: `状态`, checked: true },

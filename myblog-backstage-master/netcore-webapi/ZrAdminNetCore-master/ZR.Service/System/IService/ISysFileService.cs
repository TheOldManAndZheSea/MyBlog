...
namespace ZR.Service.System.IService
{
    public interface ISysFileService : IBaseService<SysFile>
    {
        ...
        (HttpStatusCode, string, string) SaveFile(string picdir, IFormFile formFile);
        (HttpStatusCode, string, string) SaveFile(string picdir, IFormFile formFile, string customFileName, string bucketName);
        /// <summary>
        /// 按时间来创建文件夹
        /// </summary>
